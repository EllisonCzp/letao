    ...
    function(a, b) {
        ...
        var c = Math.round,
            ...
            A = function() {
                var a = !1;
                try {
                    var c = Object.defineProperty({}, "passive", { get: function() { a = !0 } });
        ...
        var B = null;
        b.addEventListener("scroll", function() { a.isScrolling = !0, B && clearTimeout(B), B = setTimeout(function() { a.isScrolling = !1 }, 250) })
    }(mui, window),
    function(a, b) {
        var c = 0,
            d = function(d, e) {
            ...
            if (window.__NWin_Enable__ !== !1) {
                var c = "mui-plus-pullrefresh",
                    ...
                    k = a.Class.extend({
                        ...
                        setStopped: function(a) { this.stopped = !!a, this.stopped ? (this.disablePullupToRefresh(), this.disablePulldownToRefresh()) : (this.enablePullupToRefresh(), this.enablePulldownToRefresh()) },
                        ...
                        disablePulldownToRefresh: function() {
                            var a = plus.webview.currentWebview();
                            this.options.down.style && "circle" == this.options.down.style ? this.options.webview.setPullToRefresh({ support: !1, style: "circle" }) : (a.setStyle({ bounce: "none" }), a.setBounce({ position: { top: "none" } }))
                        },
                        enablePulldownToRefresh: function() {
                            var a = this,
                                b = plus.webview.currentWebview(),
                                c = this.options.down.height;
                            this.options.down.style && "circle" == this.options.down.style ? b.setPullToRefresh({ support: !0, height: c || "50px", range: a.options.down.range || "100px", style: "circle", offset: a.options.down.offset || "0px" }) : (b.setStyle({ bounce: "vertical" }), b.setBounce({ position: { top: 2 * c + "px" }, changeoffset: { top: c + "px" } }))
                        },
